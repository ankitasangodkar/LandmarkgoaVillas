...
if ( ! class_exists( 'pado_Setup' ) ) {
	class pado_Setup {
		...
		public function admin_menus() {
			add_theme_page( esc_html__( 'Import Demo Data', 'pado-plugins' ), esc_html__( 'Import Demo Data', 'pado-plugins' ), 'manage_options', $this->theme_name . '-setup', array(
				$this,
				'setup_wizard'
			) );
		}
		...
		public function setup_wizard() {
			...
			wp_localize_script( 'envato-setup', 'envato_setup_params', array(
				...
				'verify_text'      => esc_html__( '...verifying', 'pado-plugins' ),
			) );
			...
			$this->steps = array(
				'introduction' => array(
					'name'    => esc_html__( 'Introduction', 'pado-plugins' ),
		...
		public function setup_wizard_footer() {
			...
			<?php if ( 'next_steps' === $this->step ) : ?>
                <a class="wc-return-to-dashboard"
                   href="<?php echo esc_url( admin_url() ); ?>"><?php esc_html_e( 'Return to the WordPress Dashboard', 'pado-plugins' ); ?></a>
			<?php endif; ?>
            </body>
			<?php
		...
		public function envato_setup_introduction() {
			if ( isset( $_REQUEST['export'] ) ) {
				...
				?>
                <h1><?php esc_html_e( 'Current Settings:', 'pado-plugins' ); ?></h1>
                <p><?php esc_html_e( 'Widget Positions:', 'pado-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $widget_positions ); ?></textarea>
                <p><?php esc_html_e( 'Widget Options:', 'pado-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $widget_options ); ?></textarea>
                <p><?php esc_html_e( 'Menu IDs:', 'pado-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $menu_ids ); ?></textarea>
                <p><?php esc_html_e( 'Custom Options:', 'pado-plugins' ); ?></p>
                <textarea style="width:100%; height:80px;"><?php echo json_encode( $my_options ); ?></textarea>
                <p><?php esc_html_e( 'Copy these values into your PHP code when distributing/updating the theme.', 'pado-plugins' ); ?></p>
				<?php
			} else {
				?>
                <h1><?php esc_html_e( 'Welcome to Pado install!', 'pado-plugins' ); ?></h1>
                <p><?php esc_html_e( "Everyone hates to install-but you will love this! Our rocket-fast install wizard will do most of the work for you. We'll have a couple of questions along the way, but right now you are ", 'pado-plugins' ); ?>
                    <u><?php esc_html_e( 'only minutes', 'pado-plugins' ); ?></u><?php esc_html_e( " padoy from having an awesome looking blog for the whole world to see.", 'pado-plugins' ); ?>
                </p>
                <p><?php esc_html_e( 'By the way, if you are slammed for time and can\'t spare 5 minutes right now, no problem! Come back to this "dashboard" page when you have a little more time and we\'ll be waiting right here-ready to go!', 'pado-plugins' ); ?></p>
                <div class="text-info-server-wrap">
                    <div class="text-info">
		                ...
		                ?>
                        <div class="item-info">
                            <a href="#" class="refresh utton-primary button button-large"><?php esc_html_e('Refresh', 'pado-plugins'); ?></a>
                        </div>
                        <table>
                            <tr>
                                <td></td>
                                <td><?php esc_html_e('Recommended', 'pado-plugins'); ?></td>
                                <td><?php esc_html_e('Actual', 'pado-plugins'); ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('PHP Version', 'pado-plugins'); ?></td>
                                <td><?php esc_html_e('5.6.0', 'pado-plugins'); ?></td>
                                <td class="<?php echo esc_attr($phpClass); ?>"><?php echo $phpVersion; ?></td>
                            </tr>
                            <tr>
                            <tr>
                                <td><?php esc_html_e('Upload Max Filesize', 'pado-plugins'); ?></td>
                                <td><?php esc_html_e('8M', 'pado-plugins'); ?></td>
                                <td class="<?php echo esc_attr($upload_max_filesizeClass); ?>"><?php echo $upload_max_filesize; ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Memory limit', 'pado-plugins'); ?></td>
                                <td><?php esc_html_e('128M', 'pado-plugins'); ?></td>
                                <td class="<?php echo esc_attr($memory_limitClass); ?>"><?php echo $memory_limit; ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Max Execution Time', 'pado-plugins'); ?></td>
                                <td><?php esc_html_e('120', 'pado-plugins'); ?></td>
                                <td class="<?php echo esc_attr($max_execution_timeClass); ?>"><?php echo $max_execution_time; ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Post Max Size', 'pado-plugins'); ?></td>
                                <td><?php esc_html_e('8M', 'pado-plugins'); ?></td>
                ...
                <p class="envato-setup-actions step">
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button-primary button button-large button-next"><?php esc_html_e( 'Let\'s Go!', 'pado-plugins' ); ?></a>
                    <a href="<?php echo esc_url( wp_get_referer() ? wp_get_referer() : admin_url( '' ) ); ?>"
                       class="button button-large"><?php esc_html_e( 'Not right now', 'pado-plugins' ); ?></a>
                </p>
				<?php
			}
		}
		...
		public function envato_setup_default_plugins() {
			...
			?>
            <h1><?php esc_html_e( 'Default Plugins', 'pado-plugins' ); ?></h1>
            <form method="post">
				...
				if ( count( $plugins['all'] ) ) {
					?>
                    <p><?php esc_html_e( 'Some of these you Must Have and some of them you\'ll Want to Have...', 'pado-plugins' ); ?></p>
					...
					echo '<p><strong>' . esc_html__( 'Good news! All plugins are already installed and up to date. Please continue.', 'pado-plugins' ) . '</strong></p>';
				} ?>

                <p class="envato-setup-actions step">
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button-primary button button-large button-next"
                       data-callback="install_plugins"><?php esc_html_e( 'Continue', 'pado-plugins' ); ?></a>
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button button-large button-next"><?php esc_html_e( 'Skip this step', 'pado-plugins' ); ?></a>
		...
		public function ajax_plugins() {
			if ( ! check_ajax_referer( 'envato_setup_nonce', 'wpnonce' ) || empty( $_POST['slug'] ) ) {
				wp_send_json_error( array(
					'error'   => 1,
					'message' => esc_html__( 'No Slug Found', 'pado-plugins' )
				) );
			}
			$json = array();
			...
			foreach ( $plugins['activate'] as $slug => $plugin ) {
				if ( $_POST['slug'] == $slug ) {
					$json = array(
						...
						'action2'       => - 1,
						'message'       => esc_html__( 'Activating Plugin', 'pado-plugins' ),
					);
					break;
				}
			}
			foreach ( $plugins['update'] as $slug => $plugin ) {
				if ( $_POST['slug'] == $slug ) {
					$json = array(
						...
						'action2'       => - 1,
						'message'       => esc_html__( 'Updating Plugin', 'pado-plugins' ),
					);
					break;
				}
			}
			foreach ( $plugins['install'] as $slug => $plugin ) {
				if ( $_POST['slug'] == $slug ) {
					$json = array(
						...
						'action2'       => - 1,
						'message'       => esc_html__( 'Installing Plugin', 'pado-plugins' ),
					);
					break;
				}
			}
			...
			if ( $json ) {
				...
				wp_send_json( array( 'done' => 1, 'message' => esc_html__( 'Success', 'pado-plugins' ) ) );
			}
			exit;
		...
		private function _content_default_get() {
			...
			$content['widgets'] = array(
                'title' => esc_html__( 'Widgets', 'pado-plugins' ),
                'description' => esc_html__( 'Cool "widgets" on your sidebar that you will make your page come alive with options.', 'pado-plugins' ),
                'pending' => esc_html__( 'Pending.', 'pado-plugins' ),
                'installing' => esc_html__( 'Installing Default Widgets.', 'pado-plugins' ),
                'success' => esc_html__( 'Success.', 'pado-plugins' ),
                'install_callback' => '_content_install_widgets',
            );

            $content['codestar'] = array(
                'title' => esc_html__( 'Enable default options', 'pado-plugins' ),
                'description' => esc_html__( 'Change logo colors, fonts, layout... you know, the cool stuff.','pado-plugins' ),
                'pending' => esc_html__( 'Pending.','pado-plugins' ),
                'installing' => esc_html__( 'Installing Default Theme Settings.','pado-plugins' ),
                'success' => esc_html__( 'Success.','pado-plugins' ),
                'install_callback' => '_content_install_codestar',
            );

            $content['settings'] = array(
                'title' => esc_html__( 'Settings', 'pado-plugins' ),
                'description' => esc_html__( 'General settings help you to customize your site.', 'pado-plugins' ),
                'pending' => esc_html__( 'Pending.', 'pado-plugins' ),
                'installing' => esc_html__( 'Installing Default Settings.', 'pado-plugins' ),
                'success' => esc_html__( 'Success.', 'pado-plugins' ),
                'install_callback' => '_content_install_settings',
            );

            $content['customize'] = array(
                'title' => esc_html__( 'Customize options', 'pado-plugins' ),
                'description' => esc_html__( "You'll see-more cool stuff to play with.", 'pado-plugins' ),
                'pending' => esc_html__( 'Pending.', 'pado-plugins' ),
                'installing' => esc_html__( 'Installing Default Customize Settings.', 'pado-plugins' ),
                'success' => esc_html__( 'Success.', 'pado-plugins' ),
            ...
            <form method="post">
                ...
                <div class="envato-setup-pages">
                    <div class="importer-pages-wrap">
                        ...
                        <div class="install-text">
		                    <?php esc_html_e('Installing Demo Data...', 'pado-plugins'); ?>
                        </div>
                    </div>
                </div>
                ...
                <p class="envato-setup-actions step hide">
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       ...
                       data-callback="install_content"><?php esc_html_e( 'Continue', 'pado-plugins' ); ?></a>
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button button-large button-next"><?php esc_html_e( 'Skip this step', 'pado-plugins' ); ?></a>
					<?php wp_nonce_field( 'envato-setup' ); ?>
                </p>
		...
		public function ajax_content() {
			...
			if ( ! check_ajax_referer( 'envato_setup_nonce', 'wpnonce' ) || empty( $_POST['content'] ) && isset( $content[ $_POST['content'] ] ) ) {
				wp_send_json_error( array(
					'error'   => 1,
					'message' => esc_html__( 'No content Found', 'pado-plugins' )
				) );
			}
			...
			if ( ! empty( $json ) ) {
				...
				wp_send_json( array( 'error' => 1, 'message' => esc_html__( 'Error', 'pado-plugins' ) ) );
			}
		...
		private function _content_install_widgets() {
			...
			foreach ( $data as $sidebar_id => $widgets ) {
				...
				if ( isset( $wp_registered_sidebars[ $sidebar_id ] ) ) {
					...
					$sidebar_message      = esc_html__( 'Sidebar does not exist in theme (using Inactive)', 'pado-plugins' );
				}
				...
				foreach ( $widgets as $widget_instance_id => $widget ) {
					...
					if ( ! $fail && ! isset( $available_widgets[ $id_base ] ) ) {
						...
						$widget_message      = esc_html__( 'Site does not support widget', 'pado-plugins' ); // explain why widget not imported
					}
					...
					if ( ! $fail && isset( $widget_instances[ $id_base ] ) ) {
						...
						foreach ( $single_widget_instances as $check_id => $check_widget ) {
							...
							if ( in_array( "$id_base-$check_id", $sidebar_widgets ) && (array) $widget == $check_widget ) {
								...
								$widget_message      = esc_html__( 'Widget already exists', 'pado-plugins' ); // explain why widget not imported
					...
					if ( ! $fail ) {
						...
						if ( $sidebar_available ) {
							...
							$widget_message      = esc_html__( 'Imported', 'pado-plugins' );
						} else {
							$widget_message_type = 'warning';
							$widget_message      = esc_html__( 'Imported to Inactive', 'pado-plugins' );
						}
					...
					$results[ $sidebar_id ]['widgets'][ $widget_instance_id ]['title']        = $widget->title ? $widget->title : esc_html__( 'No Title', 'pado-plugins' ); // show "No Title" if widget instance is untitled
		...
		public function envato_setup_logo_design() {
			...
			?>
            <h1><?php esc_html_e( 'Logo &amp; Design', 'pado-plugins' ); ?></h1>
            <form method="post">
                <p><?php esc_html_e( 'Please add your logo below. For best results, the logo should be a transparent PNG ( 190 by 35 pixels). The logo can be changed at any time from the Appearance > Customize area in your dashboard.', 'pado-plugins' ); ?> </p>
                <table>
                    <tr>
                        <td>
                            <div id="current-logo">
                        ...
                        <td>
                            <a href="#"
                               class="button button-upload"><?php esc_html_e( 'Upload New Logo', 'pado-plugins' ); ?></a>
                        </td>
                    </tr>
                </table>


                <p><?php esc_html_e( 'Please choose the color scheme for this website. The color scheme (along with font colors &amp; styles) can be changed at any time from the Appearance > Customize area in your dashboard.', 'pado-plugins' ); ?></p>
                ...
                <p class="envato-setup-actions step">
                    <input type="submit" class="button-primary button button-large button-next"
                           value="<?php esc_attr_e( 'Continue', 'pado-plugins' ); ?>" name="save_step"/>
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button button-large button-next"><?php esc_html_e( 'Skip this step', 'pado-plugins' ); ?></a>
					<?php wp_nonce_field( 'envato-setup' ); ?>
                </p>
		...
		public function envato_setup_customize() {
            ...
            <h1><?php esc_html_e( 'Theme Customization', 'pado-plugins' ); ?></h1>
            <p>
				<?php esc_html_e( 'To change the Sidebars go to Appearance > Widgets. You can "drag & drop" the widgets into your sidebar. To control which "widget areas" appear, go to an individual page and look for the "Left/Right Column" menu. Here widgets can be chosen for display on the left or right of a page. More details in documentation.', 'pado-plugins' ); ?>
            </p>
            <p>
                <em>
					<?php echo sprintf( esc_html__( 'Advanced Users: If you are going to make changes to the theme source code please use a %s rather than modifying the main theme HTML/CSS/PHP code.', 'pado-plugins' ), '<a href="https://codex.wordpress.org/Child_Themes" target="_blank">Child Theme</a>' ); ?>
					<?php echo sprintf( esc_html__( 'This allows the parent theme to receive updates without overwriting your source code changes.%s See %s in the main folder for a sample.', 'pado-plugins' ), '<br/>', '<code>child-theme.zip</code>' ); ?>
                </em>
            </p>

            <p class="envato-setup-actions step">
                <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                   class="button button-primary button-large button-next"><?php esc_html_e( 'Continue', 'pado-plugins' ); ?></a>
            </p>
		...
		public function envato_setup_ready() {
            ...
            <h1><?php esc_html_e( 'Your Website is Ready!', 'pado-plugins' ); ?></h1>

            <p><?php esc_html_e( 'In the future, if you would like to modify your theme, simply login to your WordPress dashboard, and padoy you go!', 'pado-plugins' ); ?></p>

            <div class="envato-setup-next-steps">
                <div class="envato-setup-next-steps-first">
                    <h2><?php esc_html_e( 'Next Steps', 'pado-plugins' ); ?></h2>
                    <ul>
                        <li class="setup-product"><a class="button button-primary button-large" target="_blank"
                                                     href="<?php echo esc_url( home_url( '/' ) ); ?>"><b><?php esc_html_e( 'VIEW YOUR NEW WEBSITE!', 'pado-plugins' ); ?></b></a>
                        </li>
                    </ul>
                </div>
                <div class="envato-setup-next-steps-last">
                    <h2><?php esc_html_e( 'More Resources', 'pado-plugins' ); ?></h2>
                    <ul>
                        <li class="howto"><a href="https://wordpress.org/support/"
                                             target="_blank"><?php esc_html_e( 'Learn how to use WordPress', 'pado-plugins' ); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
