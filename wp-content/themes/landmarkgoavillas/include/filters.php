...
add_filter( 'wp_get_attachment_image_attributes', 'pado_lazy_load' );
if ( ! function_exists( 'pado_lazy_load' ) ) {
	function pado_lazy_load( $data ) {
			if (
		...
		return apply_filters( 'pado_lazy_load', $data );
	}
}

if ( ! function_exists( 'pado_the_lazy_load_flter' ) ) {
	function pado_the_lazy_load_flter( $id, $attr = array(), $state = true, $size = 'full', $uri_img = '') {
